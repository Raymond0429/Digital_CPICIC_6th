...
def dct_8x8_blk_cal(blk_8x8_data):
    ...
    for vector_idx in range(8):
        ...
        p_out,q_out,o_out= dct_8x8_vector_cal(vector_in)
        p_result.append(p_out)
        q_result.append(q_out)
        o_result.append(o_out)
    return (p_result,q_result,o_result)
...
def dct_8x8_vector_cal(vector_in):
    ...
    p_out = [p0,p1,p2,p3,p4,p5,p6,p7]
    q_out = [q0,q1,q2,q3,q4,q5,q6,q7]
    o_out = [o0,o1,o2,o3,o4,o5,o6,o7]

    return (p_out,q_out,o_out)
...
if __name__ == '__main__':
    ...
    data_array     = gen_data(-128,127,8*8*16)
    ...
    for blk_idx in range(len(data_array_8x8)):
        ...
        write_blk_8x8_data(data_path,'blk_8x8_orig',blk_8x8_data,2)
        blk_8x8_data_p,blk_8x8_data_q,blk_8x8_data_1d = dct_8x8_blk_cal(blk_8x8_data)
        write_blk_8x8_data(data_path,'p',blk_8x8_data_p,3)
        write_blk_8x8_data(data_path,'q',blk_8x8_data_q,3)
        write_blk_8x8_data(data_path,'tmp_row',blk_8x8_data_1d,3)
        blk_8x8_data_1d_tm = transpose_mitrix(blk_8x8_data_1d)
        write_blk_8x8_data(data_path,'tmp_col',blk_8x8_data_1d_tm,3)
